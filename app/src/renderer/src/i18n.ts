...
const en: Record<string, string> = {
  ...
  'settings.copilot': 'GitHub Copilot', 'settings.signin': 'Sign in to GitHub Copilot',
  ...
  'settings.signedInHint': 'You are signed in; no further sign-in is needed.',
  'settings.waiting': 'Waiting for the sign-in to finish in the terminal window…',
  'settings.loginTimeout': 'Still not signed in after ten minutes. Start the sign-in again.',
  'settings.quota': '{name}: {remaining}% remaining, resets on {reset}',
  'settings.quotaNoResetLine': '{name}: {remaining}% remaining (no reset date)',
  'quota.premium_interactions': 'Premium requests', 'quota.chat': 'Chat', 'quota.completions': 'Code completions',
  'run.title': 'Run a forecast', 'run.team': 'Team', 'run.asof': 'As of', 'run.start': 'Run forecast', 'run.withai': 'Ask Copilot for the narrative',
  'run.running': 'Running…', 'run.again': 'Run another forecast',
  ...
  'run.progress.ai.toolDone': 'Copilot finished reading {tool}…',
  ...
  'cost.label': 'Copilot usage:', 'cost.credits': '{credits} AI credits (about ${usd})',
  'cost.tokens': '{in} tokens in, {out} out',
  'cost.request': '1 request', 'cost.requests': '{n} requests', 'cost.premium': '{n} premium requests',
...
const fr: Record<string, string> = {
  ...
  'settings.copilot': 'GitHub Copilot', 'settings.signin': 'Se connecter à GitHub Copilot',
  ...
  'settings.signedInHint': 'Vous êtes connecté ; aucune nouvelle connexion n’est nécessaire.',
  'settings.waiting': 'En attente de la fin de la connexion dans la fenêtre de terminal…',
  'settings.loginTimeout': 'Toujours pas connecté après dix minutes. Relancez la connexion.',
  'settings.quota': '{name} : {remaining} % restants, réinitialisation le {reset}',
  'settings.quotaNoResetLine': '{name} : {remaining} % restants (sans date de réinitialisation)',
  'quota.premium_interactions': 'Requêtes premium', 'quota.chat': 'Discussion', 'quota.completions': 'Complétions de code',
  ...
  'run.running': 'Exécution…', 'run.again': 'Lancer une autre prévision',
  ...
  'run.progress.ai.toolDone': 'Copilot a fini de consulter {tool}…',
  ...
  'cost.label': 'Utilisation de Copilot :', 'cost.credits': '{credits} crédits IA (environ {usd} $)',
  'cost.tokens': '{in} jetons en entrée, {out} en sortie',
  'cost.request': '1 requête', 'cost.requests': '{n} requêtes',
  'cost.premium': '{n} requêtes premium',
