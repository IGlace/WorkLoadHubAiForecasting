...
- Capacity below the configured weekly hours (44 h by default) means holidays, vacation or an override; name the cause when the facts show it (vacation days appear in capacity, projects in timelines).
