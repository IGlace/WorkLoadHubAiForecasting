...
> Superseded on 2026-09-10: the Python service and desktop app this document describes are archived at the tag `archive/python-desktop-v1`. The current design is `docs/superpowers/specs/2026-09-09-java-forecast-module-design.md`. The Java module implements its allocation rule and the likely-work narrative section; the rebalancing fit table of section 6.5 is not built.
