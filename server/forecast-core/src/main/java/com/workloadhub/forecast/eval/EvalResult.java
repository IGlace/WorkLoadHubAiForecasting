...
/**
 * Everything one evaluation run produced: arrival-level scores and demand-level rows.
 *
 ...
 */
public record EvalResult(List<ScoreRow> scores, List<DemandRow> demand, String truthSource,
