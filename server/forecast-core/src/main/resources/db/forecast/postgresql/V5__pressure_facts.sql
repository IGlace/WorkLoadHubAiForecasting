...
ALTER TABLE forecast_member_windows ADD COLUMN backlog_excess_hrs double precision NOT NULL DEFAULT 0;
ALTER TABLE forecast_member_windows ADD COLUMN due_excess_hrs double precision NOT NULL DEFAULT 0;
