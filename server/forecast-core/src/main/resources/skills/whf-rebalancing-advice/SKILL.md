...
5. When no target has spare hours, do not invent one: raise a team risk instead and recommend that the skill team leader above the team (`team.parent_team_id`) be told.
