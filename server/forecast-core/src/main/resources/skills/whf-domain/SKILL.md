...
## Organisation
- A **team** is a **team leader** and the people who report to them directly; `team.name` is the leader's own name. The leader is counted like any member, because they do technical work too. A **skill team leader** manages team leaders, does none, is never counted, and is named by `team.parent_team_id`: they are who a team risk is escalated to.
