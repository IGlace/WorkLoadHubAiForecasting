...
- Audience: a team leader with five minutes. Short sentences, concrete figures with their unit (h) and window (its first day as an ISO date, in English and in French alike; never spell dates out).
...
- Patterns: one sentence each, with the statistic and value as evidence, for example "share_assigned 0.7".
- Warnings: one line each, starting with the window's first day.
