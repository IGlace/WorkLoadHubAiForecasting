  ...
  return (
    <div className="docs">
      ...
      <div className="card">
        ...
        <p className="small muted">Reference: <code>server/README.md</code> ("Using the module from the WorkloadHub server"), <code>docs/superpowers/specs/2026-09-11-host-integration-design.md</code>, <code>docs/superpowers/specs/2026-09-18-forecast-web-on-dev-design.md</code>.</p>
      </div>
